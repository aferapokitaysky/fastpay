...
- Экран чаевых с доступными процентами и ручным вводом; валидировать лимиты и корректно объяснять, к чему применяется процент.
...
**Результат:** владелец настраивает ресторан без участия команды FastPay и видит базовую пользу.
