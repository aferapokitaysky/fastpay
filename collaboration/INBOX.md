...
- Reply: Готово, `feat/api-platform-foundation` @ `c93072e`. `apps/web` может собираться на реальном `@fastpay/contracts` и живом `GET /v1/public/tables/:token/bill`. Один открытый вопрос по контракту — см. COM-002.
