...
Rimvo — PWA-сервис для ресторанов: официант ведёт заказ по столу, гость сканирует QR-код, видит актуальный счёт и оплачивает его без ожидания терминала. Деньги поступают напрямую ресторану через его эквайринг; Rimvo продаётся по подписке.
